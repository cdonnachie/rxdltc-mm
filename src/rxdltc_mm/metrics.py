...
_GAUGES = (
    ...
    ("pnl_vs_hold_usd", "Effect of trading versus never trading, at current prices"),
    ("pnl_execution_edge_usd", "Value captured at fill time versus the fair price"),
    ("pnl_inventory_effect_usd", "Effect of price moves on traded coins after the trade"),
    ("trading_volume_usd", "Total traded volume in USD at the current LTC price"),
